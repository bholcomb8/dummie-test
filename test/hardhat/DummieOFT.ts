...
describe('DummieOFT Test', function () {
    // Constant representing a mock Endpoint ID for testing purposes
    const eidA = 1
    const eidB = 2
    // Declaration of variables to be used in the test suite
    let DummieOFT: ContractFactory
    ...
    before(async function () {
        ...
        DummieOFT = await ethers.getContractFactory('DummieOFTMock')
    ...
    beforeEach(async function () {
        ...
        myOFTA = await DummieOFT.deploy('aOFT', 'aOFT', mockEndpointV2A.address, ownerA.address)
        myOFTB = await DummieOFT.deploy('bOFT', 'bOFT', mockEndpointV2B.address, ownerB.address)
